...
## [Unreleased]
### Added
- Uninstalling of PowerShellGet 3 at conclusion to task to prevent interactions

### Changed
- Pinning to PowerShellGet 3.0 Preview 17 to prevent breaks as preview is updated
